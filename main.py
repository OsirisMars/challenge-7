...
### WOW! Nossa lista de alvos aumentou!
### Olha os novos alvos:
...
## Preciso saber de uma coisa... Quantas vezes o alvo "7.55.10.234" aparece na lista todos_alvos ?
## Para isso vou usar a função contar_na_lista
